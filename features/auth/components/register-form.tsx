      ...
      <div className="gradient-border rounded-xl overflow-hidden">
        <div className="bg-card/80 backdrop-blur-xl rounded-xl border border-border/40 shadow-2xl shadow-black/30">
          <div className="px-7 pt-7 pb-4 text-center border-b border-border/30">
            ...
            <p className="text-sm text-muted-foreground/70 mt-1">Create your account to begin</p>
          </div>
          <div className="p-7">
            <Form {...form}>
                ...
                <div className="grid gap-5">
                  ...
                  <div className="grid gap-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-xs font-semibold uppercase tracking-wider text-muted-foreground/70">Confirm Password</FormLabel>
                          <FormControl>
                            <Input
                              type="password"
                              placeholder="••••••••"
                  ...
                  <div className="text-center text-sm text-muted-foreground/70">
                    ...
                    <a href="/login" className="text-primary hover:text-primary/80 font-medium underline-offset-4 hover:underline transition-colors">
                      Sign In
                    </a>
                  </div>
                </div>

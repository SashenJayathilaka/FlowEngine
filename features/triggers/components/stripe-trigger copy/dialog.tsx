...
export function StripeTriggerDialog({
  ...
  const webhooksUrl = `${baseUrl}/api/webhooks/stripe?workflowId=${workflowId}`;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Use this webhooks URL to set up your Stripe account to trigger the
            flow when a payment is received.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
            ...
            <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
              ...
              <li>Paste the webhook URL into the "URL" field</li>
              <li>
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
            ...
            <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
              ...
              <li>
                ...
                - Full Stripe event payload in JSON format
              </li>
              <li>
                <code className="bg-background px-1 py-0.5 rounded">
                  {"{{stripe.eventType}}"}
